...
Всего 3 группы.
В каждой группе по 3 студента; названия предметов и ФИО преподавателей с учеными степенями для одинаковых предметов в разных группах одинаковы.
(На уровне массивов с фамилиями студентов можно добавить сортировку фамилий методом sort().)

*/

//группы в формате JSON-объектов
var group1 = '{"id": "Группа 1", "students": ["Гр1Ст1", "Гр1Ст2", "Гр1Ст3"], "disciplines": ["Предмет 1", "Предмет 2", "Предмет 3"], "tutors": ["д.т.н. Техник И.К.", "к.ф.н. Философ А.А.", "д.ф.н. Конфуций Й.Ц."], "presence": [["v", "v", "v", "v"], ["x", "v", "x", "v"], ["x", "x", "x", "x"]]}';
var group2 = '{"id": "Группа 2", "students": ["Гр2Ст1", "Гр2Ст2", "Гр2Ст3"], "disciplines": ["Предмет 1", "Предмет 2", "Предмет 3"], "tutors": ["д.т.н. Техник И.К.", "к.ф.н. Философ А.А.", "д.ф.н. Конфуций Й.Ц."], "presence": [["v", "x", "v", "x"], ["x", "v", "x", "x"], ["x", "x", "x", "x"]]}';
var group3 = '{"id": "Группа 3", "students": ["Гр3Ст1", "Гр3Ст2", "Гр3Ст3"], "disciplines": ["Предмет 1", "Предмет 2", "Предмет 3"], "tutors": ["д.т.н. Техник И.К.", "к.ф.н. Философ А.А.", "д.ф.н. Конфуций Й.Ц."], "presence": [["v", "x", "v", "x"], ["x", "v", "x", "x"], ["x", "x", "x", "x"]]}';
...
//преобразуемм их к виду JavaScript-объектов
...
//запуск приложения с выбором пользолвателем группы студентов
...
$('p.groups').click(function () {
    ...
    //напосредственно добавление строк с отметками посещаемости
    switch (groupNumber) {
        case "Группа 1":
...
//как быть с датами?
//поля для просмотра или для внесения отметок
//наследование дл 