...
Блок с информацией о посещаемости авмоматиченски меняется при выборе дисциплины.
В таблицу с датами и отметками посещаетмости циклом добавляются строки таблицы для каждого конкретного студента группы.
